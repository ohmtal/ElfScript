...
# II. For loop test counting to one billion (1000000000) and outout %

- adding if/modulo/div/print(echo) 
...
for (%i=0; %i<1000000000; %i++) {
    if ((%i % 10000000) == 0) echo ((%i / 10000000)  SPC "%");
}
```
...
ElfScipt(0.4a (*3)): 53.449u 0.105s 0:53.66 99.7%    0+0k 0+0io 0pf+0w
